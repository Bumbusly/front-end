<template>
    <svg width="22" height="15" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_308_4622)">
            <mask id="mask0_308_4622" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="22" height="15">
                <path
            ...
            <g mask="url(#mask0_308_4622)">
                <path
                    d="M19.5 0H2.5C1.39543 0 0.5 0.89543 0.5 2V13C0.5 14.1046 1.39543 15 2.5 15H19.5C20.6046 15 21.5 14.1046 21.5 13V2C21.5 0.89543 20.6046 0 19.5 0Z"
                    fill="#E71910" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M11 4L9.5 3L8.5 4H9.5L8.5 5L6.5 4V9L9.5 8L8.5 10H7.5L8.5 11L9.5 10L11 12V4ZM12.5 3L13.5 4H12.5L13.5 5L15.5 4V9L12.5 8L13.5 10H14.5L13.5 11L12.5 10L11 12V4L12.5 3Z"
                    fill="black" />
                <path
