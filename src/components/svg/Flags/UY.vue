<template>
    <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_308_6122)">
            <mask id="mask0_308_6122" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="21" height="15">
                <path
            ...
            <g mask="url(#mask0_308_6122)">
                <path
                    d="M19 0H2C0.89543 0 0 0.89543 0 2V13C0 14.1046 0.89543 15 2 15H19C20.1046 15 21 14.1046 21 13V2C21 0.89543 20.1046 0 19 0Z"
                    fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M10 3H21V5H10V3ZM10 7H21V9H10V7ZM0 11H21V13H0V11Z"
                    fill="#005CB2" />
