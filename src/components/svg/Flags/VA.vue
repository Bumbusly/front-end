<template>
    <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_308_6234)">
            <mask id="mask0_308_6234" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="21" height="15">
                <path
            ...
            <g mask="url(#mask0_308_6234)">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0 0H8V15H0V0Z" fill="#FFE200" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M8 0H14C15.1046 0 16 0.895431 16 2V13C16 14.1046 15.1046 15 14 15H8V0Z" fill="white" />
