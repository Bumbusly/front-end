<template>
    <svg width="22" height="15" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_308_4861)">
            <mask id="mask0_308_4861" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="22" height="15">
                <path
            ...
            <g mask="url(#mask0_308_4861)">
                <path
                    d="M19.5 0H2.5C1.39543 0 0.5 0.89543 0.5 2V13C0.5 14.1046 1.39543 15 2.5 15H19.5C20.6046 15 21.5 14.1046 21.5 13V2C21.5 0.89543 20.6046 0 19.5 0Z"
                    fill="#00963F" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 15L19.5 0H21.5V15H6.5Z" fill="#DE2110" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 15L21.5 0H14.5L0.5 15H7.5Z" fill="#FCDF37" />
                <path
