<template>
    <svg width="22" height="15" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_308_5932)">
            <mask id="mask0_308_5932" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="22" height="15">
                <path
            ...
            <g mask="url(#mask0_308_5932)">
                <path
                    d="M19.5 0H2.5C1.39543 0 0.5 0.89543 0.5 2V13C0.5 14.1046 1.39543 15 2.5 15H19.5C20.6046 15 21.5 14.1046 21.5 13V2C21.5 0.89543 20.6046 0 19.5 0Z"
                    fill="#4A94E1" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M11.0011 9.33L8.91109 10.43L9.31109 8.103L7.62109 6.456L9.95709 6.116L11.0011 4L12.0461 6.116L14.3811 6.456L12.6911 8.103L13.0911 10.429"
                    fill="white" />
                <path
