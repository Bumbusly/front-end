<template>
    <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_308_6066)">
            <mask id="mask0_308_6066" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="21" height="15">
                <path
            ...
            <g mask="url(#mask0_308_6066)">
                <path
                    d="M19 0H2C0.89543 0 0 0.89543 0 2V13C0 14.1046 0.89543 15 2 15H19C20.1046 15 21 14.1046 21 13V2C21 0.89543 20.1046 0 19 0Z"
                    fill="#E70B17" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M14.0021 8.65201L12.8401 9.262L13.0621 7.969L12.1221 7.052L13.4221 6.862L14.0021 5.686L14.5821 6.863L15.8821 7.053L14.9421 7.968L15.1641 9.261"
                    fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd"
