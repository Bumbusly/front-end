<template>
    <svg width="22" height="15" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_308_4734)">
            <mask id="mask0_308_4734" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="22" height="15">
                <path
            ...
            <g mask="url(#mask0_308_4734)">
                <path
                    d="M19.5 0H2.5C1.39543 0 0.5 0.89543 0.5 2V13C0.5 14.1046 1.39543 15 2.5 15H19.5C20.6046 15 21.5 14.1046 21.5 13V2C21.5 0.89543 20.6046 0 19.5 0Z"
                    fill="#FBE22B" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.5 10H21.5V15H0.5V10ZM0.5 0H21.5V5H0.5V0Z"
                    fill="#00ABCB" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.5 0V15.033L11.5 7.5L0.5 0Z" fill="black" />
                <path
