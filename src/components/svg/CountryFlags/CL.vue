<template>
    <svg width="22" height="15" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_308_4881)">
            <mask id="mask0_308_4881" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="22" height="15">
                <path
            ...
            <g mask="url(#mask0_308_4881)">
                <path
                    d="M19.5 0H2.5C1.39543 0 0.5 0.89543 0.5 2V13C0.5 14.1046 1.39543 15 2.5 15H19.5C20.6046 15 21.5 14.1046 21.5 13V2C21.5 0.89543 20.6046 0 19.5 0Z"
                    fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.5 0H9.5V8H0.5V0Z" fill="#0034A9" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M5.00007 5.227L3.53007 6L3.81007 4.364L2.62207 3.204L4.26507 2.966L5.00007 1.476L5.73507 2.966L7.37807 3.206L6.18807 4.364L6.47007 6"
                    fill="white" />
