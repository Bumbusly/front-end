            ...
            <div class="flex">
              <div id="country-input">
                <div class="flex items-center">
                  <label for="country"
                    class="flex flex-row justify-center align-center items-center cursor-pointer rounded-l-md border-0 py-2 px-2 text-yellow-900 shadow-sm ring-1 ring-inset ring-yellow-900 placeholder:text-yellow-700 focus:ring-2 focus:ring-inset focus:ring-yellow-600 sm:text-sm sm:leading-6">
                    <label for="country" class="block text-sm font-medium leading-6 text-yellow-900">USA</label>
                    <svg class="w-4 h-4 mx-2 fill-current rotate-180" xmlns="http://www.w3.org/2000/svg"
